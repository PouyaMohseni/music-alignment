...
#SBATCH --mem=32G
#SBATCH --time=4:00:00
#SBATCH --output=/project/def-ichiro/pmohseni/music-alignment/results/v5j_long/slurm-%j.log
#SBATCH --error=/project/def-ichiro/pmohseni/music-alignment/results/v5j_long/slurm-%j.log

echo "Job started on $(hostname) at $(date)"
nvidia-smi

cd /project/def-ichiro/pmohseni/music-alignment
mkdir -p results/v5j_long
...
# v5j: v5i architecture (bidir+residual+512) trained for 20k steps
python -m mymodel.v5_recurrent.train \
  --config configs/v5j_long.yaml \
