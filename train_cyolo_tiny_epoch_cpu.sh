#!/bin/bash
#SBATCH --job-name=cyolo-tiny-epoch
#SBATCH --account=def-ichiro
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=3:00:00
#SBATCH --output=/project/def-ichiro/pmohseni/music-alignment/results/cyolo_tiny_epoch-%j.log
#SBATCH --error=/project/def-ichiro/pmohseni/music-alignment/results/cyolo_tiny_epoch-%j.log
