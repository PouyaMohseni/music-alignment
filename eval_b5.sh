...
# Interim spot-check of B5_dense_contrastive_aux on its current best_model.pt -- training is
# still in progress as of submission, so this is not a final result. Uses
# the generic eval_official.py path since B5_dense_contrastive_aux's checkpoint is a plain
