...
# Interim spot-check of B6_impulse_response on its current best_model.pt -- training is
# still in progress as of submission, so this is not a final result. Uses
# the generic eval_official.py path since B6_impulse_response's checkpoint is a plain
