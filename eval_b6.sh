#!/bin/bash
#SBATCH --job-name=eval-b6
#SBATCH --account=def-ichiro
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=4:00:00
#SBATCH --output=/project/def-ichiro/pmohseni/music-alignment/results/eval_b6-%j.log
#SBATCH --error=/project/def-ichiro/pmohseni/music-alignment/results/eval_b6-%j.log

# Interim spot-check of B6_impulse_response on its current best_model.pt --
...
# native portrait per-page format B6 was actually trained on (e.g. 1181x835,
...
CKPT_DIR=$(find results/cb_ta_ext/B6_impulse_response/params -maxdepth 1 -name "*_B6_impulse_response" -type d | sort | tail -1)
...
echo "=== Native eval_model.py: B6_impulse_response on msmd_test ==="
