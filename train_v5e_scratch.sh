#!/bin/bash
#SBATCH --job-name=music-v5e_scratch
...
#SBATCH --mem=32G
#SBATCH --time=2:00:00
#SBATCH --output=/project/def-ichiro/pmohseni/music-alignment/results/v5e_scratch/slurm-%j.log
#SBATCH --error=/project/def-ichiro/pmohseni/music-alignment/results/v5e_scratch/slurm-%j.log

echo "Job started on $(hostname) at $(date)"
nvidia-smi

cd /project/def-ichiro/pmohseni/music-alignment
mkdir -p results/v5e_scratch
...
python -m mymodel.v5_recurrent.train \
  --config configs/v5e_scratch.yaml \
  $INIT_ARG \
