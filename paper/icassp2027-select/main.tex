...
nothing on real audio. Replacing the perception model's audio encoder does not help either: retrained
with a MERT tower~\cite{li2024mert} it reaches 46.2 against 90.6, and with the
Mamba encoder of~\cite{yang2026coda}, \tbd{pending}. The oracle predicted this.
