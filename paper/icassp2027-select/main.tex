...
same real-time commitments recovers almost everything the deployed rule loses. We therefore recast the
...
(Fig.~\ref{fig:analysis}a), which locates the remaining difficulty in the
...
every scored onset, and an oracle held to the same real-time commitments
