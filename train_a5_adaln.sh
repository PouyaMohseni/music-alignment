...
#SBATCH --mem=64G
#SBATCH --time=3:00:00
#SBATCH --output=/project/def-ichiro/pmohseni/music-alignment/results/a5_adaln-%j.log
#SBATCH --error=/project/def-ichiro/pmohseni/music-alignment/results/a5_adaln-%j.log

# adaLN-Zero in place of FiLM -- conditioning ablation, everything else identical
#
...
echo "=== ${TAG}: adaLN-Zero in place of FiLM -- conditioning ablation, everything else identical ==="
python /project/def-ichiro/pmohseni/music-alignment/extensions/hooks/run_train_a5_adaln.py \
