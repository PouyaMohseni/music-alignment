...
# Interim spot-check of B4_temporal_consistency on its current best_model.pt -- training is
# still in progress as of submission, so this is not a final result. Uses
# the generic eval_official.py path since B4_temporal_consistency's checkpoint is a plain
