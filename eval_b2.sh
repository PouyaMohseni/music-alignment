#!/bin/bash
#SBATCH --job-name=eval-b2
#SBATCH --account=def-ichiro
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=4:00:00
#SBATCH --output=/project/def-ichiro/pmohseni/music-alignment/results/eval_b2-%j.log
#SBATCH --error=/project/def-ichiro/pmohseni/music-alignment/results/eval_b2-%j.log

# Interim spot-check of B2_pitch_aux on its current best_model.pt -- training
...
# native portrait per-page format B2 was actually trained on (e.g. 1181x835,
...
CKPT_DIR=$(find results/cb_ta_ext/B2_pitch_aux/params -maxdepth 1 -name "*_B2_pitch_aux" -type d | sort | tail -1)
