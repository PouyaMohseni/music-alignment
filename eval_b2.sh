...
# Interim spot-check of B2_pitch_aux on its current best_model.pt -- training is
# still in progress as of submission, so this is not a final result. Uses
# the generic eval_official.py path since B2_pitch_aux's checkpoint is a plain
