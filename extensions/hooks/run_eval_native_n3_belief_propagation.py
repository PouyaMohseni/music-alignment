"""Eval wrapper for N3 (gated differentiable Bayes filter) -- applies the same patches as
run_train_n3_belief_propagation.py, then runs CPJKU's own unmodified eval_model.py
