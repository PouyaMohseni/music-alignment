"""Eval wrapper for B1a + SpatialFiLM (extensions/hooks/spatial_film_patch.py,
SPADE-inspired spatially-varying gamma/beta): same runpy-into-eval_model.py
pattern as run_eval_native_mert.py, plus the spatial-FiLM patch on top of
the frozen-MERT audio swap.
"""
import os
import runpy
import sys
