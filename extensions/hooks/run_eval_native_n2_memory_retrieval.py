"""Eval wrapper for N2 (gated lag-aware memory retrieval) -- applies the same patches as
run_train_n2_memory_retrieval.py, then runs CPJKU's own unmodified eval_model.py
