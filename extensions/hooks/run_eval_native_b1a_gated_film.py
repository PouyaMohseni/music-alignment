"""Eval wrapper for B1a + GatedFiLM (extensions/hooks/gated_film_patch.py,
AdaLN-Zero-style zero-initialized gate): same runpy-into-eval_model.py
pattern as run_eval_native_mert.py, plus the gated-FiLM patch on top of the
frozen-MERT audio swap.
"""
import os
import runpy
import sys
