#!/bin/bash
#SBATCH --job-name=featk
#SBATCH --account=def-ichiro
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --time=3:00:00
#SBATCH --output=/project/def-ichiro/pmohseni/music-alignment/results/featk-%j.log
...
M=/scratch/pmohseni/omr/scorer; R=/scratch/pmohseni/omr/featk; mkdir -p "$R"
