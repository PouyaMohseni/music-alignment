...
#SBATCH --output=/project/def-ichiro/pmohseni/music-alignment/results/v12b-%j.log
#SBATCH --error=/project/def-ichiro/pmohseni/music-alignment/results/v12b-%j.log

# v12b: MERT(frozen) + BiLSTM(768->1024) + InfoNCE
# ~10M trainable params (LSTM + head only)
